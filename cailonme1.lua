...
Library:Notify({
    ...
    Settings1 = Window:AddTab({
        Title = "Config"
        
    }),
    Melee1 = Window:AddTab({
    ...
    Quests1 = Window:AddTab({
        Title = "Items Farm"
      
    })
    SeaEvent1 = Window:AddTab({
        Title = "Sea Events"
       
    })
    Mirage1 = Window:AddTab({
        Title = "Mirage + RaceV4"
    })
    Drago1= Window:AddTab({
        Title = "Dragon Dojo"
    })
    Prehistoric1 = Window:AddTab({
        Title = "Prehistoric"
    }),
    Raids1 = Window:AddTab({
        Title = "Raid"
    })
    Combat1 = Window:AddTab({
        Title = "Combat PVP"
    })
    Travel1 = Window:AddTab({
        Title = "Teleport"
    })
    Fruit1 = Window:AddTab({
        Title = "Fruits"
    })
    Shop1 = Window:AddTab({
        Title = "Shop"
...
local FarmLevel = Main:AddToggle("FarmLevel", {
...
local TravelDress = Main:AddToggle("TravelDress", {
...
local Main = Main1:AddLeftGroupbox("Miscellanea / Quest")

local ClosetMons = Main:AddToggle("ClosetMons", {
...
local FactoryRaids = Main:AddToggle("FactoryRaids", {
...
local CastleRaids = Main:AddToggle("CastleRaids", {
...
local Bartilo = Main:AddToggle("Bartilo", {
...
local CitizenQ = Main:AddToggle("CitizenQ", {
...
local Berry = Main:AddToggle("Berry", {
...
local Chest = Main:AddToggle("Chest", {
...
local Mastery_Config = Main:AddDropdown("Mastery_Config", {
    Title = "Choose Island",
    Values = posMastery,
    Multi = false,
    Default = 1
...
local MasteryFruits = Main:AddToggle("MasteryFruits", {
...
local MasteryGun = Main:AddToggle("MasteryGun", {
...
local MasterySword = Main:AddToggle("MasterySword", {
...
local Settings = Settings1:AddLeftGroupbox("Settings / Configure")
local _Weapon = {
    "Melee",
    "Sword",
    "Blox Fruit",
...
local Weapon_Config = Settings:AddDropdown("Weapon_Config", {
    Title = "Select Weapon",
    Values = _Weapon,
    Multi = false,
    Default = 1
...
local Initialize = Settings:AddToggle("Initialize", {
...
local Bringmob = Settings:AddToggle("Bringmob", {
    Title = "Bring Mobs",
    Description = "",
    Default = true
})
...
local BusuAura = Settings:AddToggle("BusuAura", {
...
local RaceV3Aura = Settings:AddToggle("RaceV3Aura", {
...
local RaceV4Aura = Settings:AddToggle("RaceV4Aura", {
...
local RandomAround = Settings:AddToggle("RandomAround", {
...
local Byp = Settings:AddToggle("Byp", {
...
local SafeModes = Settings:AddToggle("SafeModes", {
    Title = "Panic Mode",
...
local UnDetectedAFK = Settings:AddToggle("UnDetectedAFK", {
    Title = "Anti AFK",
    Description = "",
    Default = true
})
...
local DisblesVFX = Settings:AddToggle("DisblesVFX", {
...
local StatusSelect = Settings:AddSlider("StatusSelect", {
    Title = "Stats Value",
...
local StatsUpg = Settings:AddToggle("StatsUpg", {
    Title = "Auto Melee",
    Description = "",
    Default = false
})
...
local Melee = Melee1:AddLeftGroupbox("Fighting Melee Styles")
local SuperHuman = Melee:AddToggle("SuperHuman", {
...
local DeathStep = Melee:AddToggle("DeathStep", {
...
local SharkManV2 = Melee:AddToggle("SharkManV2", {
...
local ElectricClaw = Melee:AddToggle("ElectricClaw", {
...
local DragonTalon = Melee:AddToggle("DragonTalon", {
...
local Godhuman = Melee:AddToggle("Godhuman", {
    Title = "Auto Godhuman",
    Description = "",
    Default = false
})
...
local SanguineArt = Melee:AddToggle("SanguineArt", {
...
local Quests = Quests1:AddLeftGroupbox("Cursed Dual Katana")
...
local Toggle = New:AddToggle("Toggle", {Title="Farm Summon Token",Description="",Default=false});
Toggle:OnChanged(function(Value)
...
local Mirage = Mirage1:AddLeftGroupbox("Mystic Island / Full Moon")
...
local Drago = Drago1:AddLeftGroupbox("Dojo Quest & Drago Race")
local DojoQ = Drago:AddToggle("DojoQ", {
...
local BlazeEM = Drago:AddToggle("BlazeEM", {
...
local fireflower = Drago:AddToggle("fireflower", {
    Title = "Auto Drago (V2)",
...
local dragoTpVolcano = Drago:AddToggle("dragoTpVolcano", {
...
local bdrago = Drago:AddToggle("bdrago", {
...
local UpTalon = Drago:AddToggle("UpTalon", {
...
local Prehistoric = Prehistoric1:AddLeftGroupbox("Volcanic Magnet")
Toggle = Prehistoric:AddToggle("Toggle", {
...
Vocan = Prehistoric:AddToggle("Vocan", {
...
local Vocan = Prehistoric:AddToggle("Vocan", {
...
local SeaEvent = SeaEvent1:AddLeftGroupbox("Sea Event / Setting Sail")
local ListSeaBoat = {
    "Guardian",
    "PirateGrandBrigade",
    "MarineGrandBrigade",
...
local Q = SeaEvent:AddDropdown("Q", {
    Title = "Choose Boats",
    Values = ListSeaBoat,
    Multi = false,
    Default = 1
...
local Raids = Raids1:AddLeftGroupbox("Dungeon Event / Raiding")
...
local Combat = Combat1:AddLeftGroupbox("Combat / Aimbot")
...
local SelectedPly = Combat:AddDropdown("SelectedPly", {
...
local Travel1 = Travel1:AddLeftGroupbox("Travel - Worlds")
Travel:AddButton({
...
Travelllll = Travel:AddDropdown("Travelllll", {
...
GoIsland = Travel:AddToggle("GoIsland", {
    Title = "Auto Travel",
...
PortalTP = Travel:AddDropdown("PortalTP", {
    Title = "Select Portal",
...
NPCsPos = Travel:AddDropdown("NPCsPos", {
    Title = "Select NPCs",
    Values = NPCList,
    Multi = false,
    Default = 1
...
GoNPCs = Travel:AddToggle("GoNPCs", {
...
Sel_NFruit = Fruit:AddDropdown("Sel_NFruit", {
...
Sel_MFruit = Fruit:AddDropdown("Sel_MFruit", {
...
RandomFF = Fruit:AddToggle("RandomFF", {
...
StoredF = Fruit:AddToggle("StoredF", {
...
local Shop = Shop1:AddLeftGroupbox("")
Shop:AddButton({
    Title = "Buy Buso",
    Description = "",
    Callback = function()
...
local Misc = Misc1:AddLeftGroupbox("Server - Function")
Misc:AddButton({
    Title = "Rejoin Server",
    Description = "",
    Callback = function()
...
local JobID = Misc:AddInput("JobID", {
    Title = "JobID",
    Default = "",
    Placeholder = "",
...
DisbleChat = Misc:AddToggle("DisbleChat", {
...
DisbleLeaderB = Misc:AddToggle("DisbleLeaderB", {
...
UnPortal = Misc:AddToggle("UnPortal", {
...
HakiStat = Misc:AddDropdown("HakiStat", {
...
briggt1 = Misc:AddToggle("briggt1", {
...
dayornight = Misc:AddToggle("dayornight", {
    Title = "Turn on Time",
    Description = "",
    Default = false
})
...
walkWater = Misc:AddToggle("walkWater", {
...
iceWalk = Misc:AddToggle("iceWalk", {
