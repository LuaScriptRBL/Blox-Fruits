...
local T1UIColor = {
	...
	["Logo Image"] = "rbxassetid://5009915812",
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,206,27") .. ")\">" .. tostring("Visibility Hub") .. "</font> " .. tostring(getgenv().TitleNameNoti or "")
	...
	CloseImage.Image = "rbxassetid://5009915812"
...
function Library:CreateWindow(Setting)
    local TitleNameMain = Setting.Title or "Visibility Hub"
	...
	local colorB = tostring(Library_Function.Getcolor(getgenv().UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
    TextLabelMain.Text = "<font color=\"rgb(" .. tostring(color or "255,206,27") .. ")\">" .. tostring(TitleNameMain or "Visibility Hub") .. "</font> " .. tostring(getgenv().MainDesc or "")
	...
	function Main_Function:AddTab(PageName)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			if Toggleable then
				...
				visibility.ZIndex = 2
				visibility.Image = "rbxassetid://5009916777"
				...
				visibility_off.Image = "rbxassetid://5009916777"
