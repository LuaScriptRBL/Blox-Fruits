...
function Library:CreateWindow(Setting)
	...
	Main.Main.Position = UDim2.new(0.5, 0, 0.5, 0)
	...
	maingui.Image = "rbxassetid://5009915812"
	...
	SearchIcon.Image = "rbxassetid://5009915812"
	...
	function Main_Function:AddTab(PageName)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			if Toggleable then
				...
				visibility.ZIndex = 2
				visibility.Image = "rbxassetid://5009915812"
